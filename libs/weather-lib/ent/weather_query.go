...
func (wq *WeatherQuery) Order(o ...OrderFunc) *WeatherQuery {
...
func (wq *WeatherQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (wq *WeatherQuery) FirstIDX(ctx context.Context) int {
...
func (wq *WeatherQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (wq *WeatherQuery) OnlyIDX(ctx context.Context) int {
...
func (wq *WeatherQuery) IDs(ctx context.Context) (ids []int, err error) {
...
func (wq *WeatherQuery) IDsX(ctx context.Context) []int {
	ids, err := wq.IDs(ctx)
	if err != nil {
		panic(err)
	}
