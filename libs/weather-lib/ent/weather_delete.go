...
func (wd *WeatherDelete) Exec(ctx context.Context) (int, error) {
	return withHooks[int, WeatherMutation](ctx, wd.sqlExec, wd.mutation, wd.hooks)
}
...
func (wd *WeatherDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(weather.Table, sqlgraph.NewFieldSpec(weather.FieldID, field.TypeInt))
